import os
import sys
sys.path.append('/home/wu/caffe-ssd/python')
import caffe
...
def CreateMultiBoxOutput(net, data_layer="data", num_classes=[], from_layers=[],
        ...
        aspect_ratios=[], steps=[], offsets=[], img_height=0, img_width=0, share_location=True,
    ...
    if offsets:
        assert len(from_layers) == len(offsets), "from_layers and starts should have same length"
